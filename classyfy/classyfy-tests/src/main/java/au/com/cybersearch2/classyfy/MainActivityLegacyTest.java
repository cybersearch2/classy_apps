...
public class MainActivityLegacyTest extends ActivityInstrumentationTestCase2<MainActivity>
{
    ...
    public void test_search() throws Throwable
    {
        ...
        ActivityMonitor am2 = getInstrumentation().addMonitor(TitleSearchResultsActivity.class.getName(), null, false);
        ...
        getInstrumentation().sendCharacterSync(KeyEvent.KEYCODE_I);
        getInstrumentation().sendCharacterSync(KeyEvent.KEYCODE_N); 
        getInstrumentation().sendCharacterSync(KeyEvent.KEYCODE_F);
