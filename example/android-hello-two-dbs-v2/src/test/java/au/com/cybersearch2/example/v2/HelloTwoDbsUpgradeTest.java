...
public class HelloTwoDbsUpgradeTest
{
    ...
    public void setUp() throws Exception 
    {
	    ...
	    HelloTwoDbsMain_v1 helloTwoDbsMain_v1 = new HelloTwoDbsMain_v1(TestHelloTwoDbsApplication.getTestInstance());
        try
        {
        ...
        if (helloTwoDbsMain == null)
            helloTwoDbsMain = new AndroidHelloTwoDbs(TestHelloTwoDbsApplication.getTestInstance());
        AndroidHelloTwoDbs.applicationInitialized = false;
